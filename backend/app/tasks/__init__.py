...
These tasks are invoked by celery beat on a schedule or can be
triggered manually.  They operate on the same database and ML
pipeline used by the FastAPI application.
"""
